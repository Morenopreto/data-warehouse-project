...
function UserForm({ data }) {
    ...
    const { addUser,fetchStatus } = useContext(UserFormContext);
    ...
    return (
        ...
        <section className='form-section'>
            <Form className="form-ctn" onSubmit={(e) => submit(e)} >
                <h5>Informacion personal</h5>
                <Inputs label='Nombre' objectTag='name' type='text' prueba={prueba} />
                <Inputs label='Apellido' objectTag='surname' type='text' prueba={prueba} />
                <Inputs label='Mail' objectTag='mail' type='mail' prueba={prueba} />
                <Inputs label='Telefono' objectTag='phone' type='text' prueba={prueba} />

                <h5>Informacion de Cuenta</h5>
                <Inputs label='Contraseña' objectTag='pass' type='password' prueba={prueba} />
                <Inputs label='Repita la contraseña' objectTag='passValidation' type='password' prueba={prueba} />
                <h5>Permisos</h5>
                <Form.Group controlId="formProfile" className='blockGroup'>
                    <Form.Check
                        ...
                        onChange={(e) => prueba('admin', Number(e.target.checked))}
                    />
